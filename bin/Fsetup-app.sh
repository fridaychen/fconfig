...
case $(uname) in
    ...
    Linux)
        ...
        case $ID in
            debian)
                sudo apt install cowsay bear cmake espeak-ng figlet ffmpeg graphviz htop lolcat mbrola mbrola-us2 meld most mpg123 mpv neovim pandoc ripgrep scons silversearcher-ag tidy
                ;;

            ubuntu)
                sudo add-apt-repository ppa:mmstick76/alacritty
                sudo apt install alacritty bat cowsay bear cmake espeak-ng figlet ffmpeg graphviz htop lolcat mbrola mbrola-us2 meld most mpg123 mpv neovim pandoc ripgrep scons silversearcher-ag tidy
